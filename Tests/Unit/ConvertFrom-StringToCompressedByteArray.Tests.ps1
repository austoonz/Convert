...
Describe -Name $function -Fixture {
    ...
    $encodings = @(
        @{
            ...
            'ExpectedMacOS'   = @(31, 139, 8, 0, 0, 0, 0, 0, 0, 3, 11, 201, 200, 44, 246, 44, 246, 173, 12, 46, 41, 202, 204, 75, 7, 0, 155, 209, 238, 33, 14, 0, 0, 0)
        }
        @{
            ...
            'ExpectedMacOS'   = @(31, 139, 8, 0, 0, 0, 0, 0, 0, 3, 99, 8, 97, 200, 96, 200, 100, 40, 102, 240, 4, 98, 95, 134, 74, 134, 96, 134, 18, 134, 34, 160, 72, 30, 67, 58, 0, 14, 106, 112, 104, 28, 0, 0, 0)
        }
        @{
            'Encoding'        = 'Default'
            'ExpectedDesktop' = @(31, 139, 8, 0, 0, 0, 0, 0, 4, 0, 11, 201, 200, 44, 246, 44, 246, 173, 12, 46, 41, 202, 204, 75, 7, 0, 155, 209, 238, 33, 14, 0, 0, 0)
        ...
        @{
            ...
            'ExpectedMacOS'   = @(31, 139, 8, 0, 0, 0, 0, 0, 0, 3, 11, 97, 200, 96, 200, 100, 40, 102, 240, 4, 98, 95, 134, 74, 134, 96, 134, 18, 134, 34, 160, 72, 30, 67, 58, 3, 0, 47, 0, 246, 190, 28, 0, 0, 0)
        }
        @{
            'Encoding'        = 'UTF32'
            ...
            'ExpectedMacOS'   = @(31, 139, 8, 0, 0, 0, 0, 0, 0, 3, 11, 97, 96, 96, 200, 0, 226, 76, 32, 46, 6, 98, 79, 40, 237, 11, 196, 149, 64, 28, 12, 196, 37, 64, 92, 4, 85, 147, 7, 196, 233, 64, 12, 0, 199, 38, 120, 35, 56, 0, 0, 0)
        }
        @{
            'Encoding'        = 'UTF7'
            'ExpectedDesktop' = @(31, 139, 8, 0, 0, 0, 0, 0, 4, 0, 11, 201, 200, 44, 246, 44, 246, 173, 12, 46, 41, 202, 204, 75, 7, 0, 155, 209, 238, 33, 14, 0, 0, 0)
    ...
    foreach ($encoding in $encodings)
    {
        ...
        elseif ($IsMacOS)
        {
            $expected = $encoding.ExpectedMacOS
        }
        else
        {
