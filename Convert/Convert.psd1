...
FunctionsToExport = 'ConvertFrom-Base64ToString', 'ConvertFrom-ByteArrayToBase64',
               ...
               'ConvertFrom-Base64StringToByteArray', 'ConvertFrom-ByteArrayToMemoryStream',
               'ConvertFrom-IOStreamToString', 'ConvertFrom-MemoryStreamToDecryptRequest',
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '
v0.1.2.x:
  - Added Base64 to Byte Array
  - Added Byte Array to Memory Stream
  - Added IO Stream to String
  - Added Memory Stream to KMS Decrypt request
  - Added Memory Stream to Secure String
v0.1.1.x:
