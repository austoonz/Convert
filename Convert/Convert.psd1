...
@{
    ...
    FunctionsToExport = @('ConvertFrom-Base64', 'ConvertFrom-Base64ToString', 'ConvertFrom-ByteArrayToBase64',
        'ConvertFrom-Clixml', 'ConvertFrom-CompressedByteArrayToString',
