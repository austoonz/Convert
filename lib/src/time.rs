...
#[unsafe(no_mangle)]
pub extern "C" fn from_unix_time_ffi(
    timestamp: i64,
    milliseconds: bool,
    out_year: *mut i32,
    out_month: *mut u32,
    ...
    if out_year.is_null() || out_month.is_null() || out_day.is_null() 
        || out_hour.is_null() || out_minute.is_null() || out_second.is_null() {
        return false;
    }
...
mod tests {
    ...
    fn test_to_unix_time_epoch() {
        ...
        let result = to_unix_time(1970, 1, 1, 0, 0, 0, false);
    ...
    fn test_to_unix_time_epoch_milliseconds() {
        ...
        let result = to_unix_time(1970, 1, 1, 0, 0, 0, true);
    ...
    fn test_to_unix_time_year_2000() {
        ...
        let result = to_unix_time(2000, 1, 1, 0, 0, 0, false);
        assert_eq!(result, 946684800, "2000-01-01 00:00:00 should return 946684800 seconds");
    }

    #[test]
    fn test_to_unix_time_year_2000_milliseconds() {
        // Test: 2000-01-01 00:00:00 = 946684800000 milliseconds
        let result = to_unix_time(2000, 1, 1, 0, 0, 0, true);
        assert_eq!(result, 946684800000, "2000-01-01 00:00:00 should return 946684800000 milliseconds");
    }

    #[test]
    fn test_to_unix_time_with_time_components() {
        // Test: 2000-01-01 12:30:45 = 946684800 + 12*3600 + 30*60 + 45 = 946729845 seconds
        let result = to_unix_time(2000, 1, 1, 12, 30, 45, false);
        assert_eq!(result, 946729845, "2000-01-01 12:30:45 should return 946729845 seconds");
    }

    #[test]
    fn test_to_unix_time_with_time_components_milliseconds() {
        // Test: 2000-01-01 12:30:45 in milliseconds
        let result = to_unix_time(2000, 1, 1, 12, 30, 45, true);
        assert_eq!(result, 946729845000, "2000-01-01 12:30:45 should return 946729845000 milliseconds");
    }

    #[test]
    fn test_to_unix_time_leap_year() {
        // Test: 2000-02-29 (leap year) 00:00:00 = 946684800 + 59*86400 = 951782400 seconds
        let result = to_unix_time(2000, 2, 29, 0, 0, 0, false);
        assert_eq!(result, 951782400, "2000-02-29 00:00:00 should return 951782400 seconds");
    }

    #[test]
    fn test_to_unix_time_end_of_month() {
        // Test: 2000-01-31 23:59:59 = 946684800 + 30*86400 + 23*3600 + 59*60 + 59 = 949363199 seconds
        let result = to_unix_time(2000, 1, 31, 23, 59, 59, false);
        assert_eq!(result, 949363199, "2000-01-31 23:59:59 should return 949363199 seconds");
    }

    #[test]
    fn test_to_unix_time_recent_date() {
        // Test: 2024-01-01 00:00:00 = 1704067200 seconds
        let result = to_unix_time(2024, 1, 1, 0, 0, 0, false);
        assert_eq!(result, 1704067200, "2024-01-01 00:00:00 should return 1704067200 seconds");
    }

    #[test]
    fn test_to_unix_time_recent_date_milliseconds() {
        // Test: 2024-01-01 00:00:00 in milliseconds
        let result = to_unix_time(2024, 1, 1, 0, 0, 0, true);
        assert_eq!(result, 1704067200000, "2024-01-01 00:00:00 should return 1704067200000 milliseconds");
    }

    #[test]
    fn test_to_unix_time_different_months() {
        // Test: 2020-06-15 10:30:00 = 1592217000 seconds
        let result = to_unix_time(2020, 6, 15, 10, 30, 0, false);
        assert_eq!(result, 1592217000, "2020-06-15 10:30:00 should return 1592217000 seconds");
    }

    #[test]
    fn test_to_unix_time_end_of_year() {
        // Test: 2020-12-31 23:59:59 = 1609459199 seconds
        let result = to_unix_time(2020, 12, 31, 23, 59, 59, false);
        assert_eq!(result, 1609459199, "2020-12-31 23:59:59 should return 1609459199 seconds");
    }

    #[test]
    fn test_to_unix_time_milliseconds_flag_difference() {
        // Test: Verify milliseconds flag produces value 1000x larger
        let seconds = to_unix_time(2020, 6, 15, 10, 30, 0, false);
        let milliseconds = to_unix_time(2020, 6, 15, 10, 30, 0, true);
        assert_eq!(milliseconds, seconds * 1000, "Milliseconds should be 1000x seconds");
    }
    ...
    fn test_from_unix_time_round_trip_epoch() {
        ...
        let timestamp = to_unix_time(1970, 1, 1, 0, 0, 0, false);
    ...
    fn test_from_unix_time_round_trip_year_2000() {
        ...
        let timestamp = to_unix_time(2000, 1, 1, 0, 0, 0, false);
        let (year, month, day, hour, minute, second) = from_unix_time(timestamp, false);
    ...
    fn test_from_unix_time_round_trip_with_time() {
        ...
        let timestamp = to_unix_time(2024, 6, 15, 14, 30, 45, false);
        let (year, month, day, hour, minute, second) = from_unix_time(timestamp, false);
    ...
    fn test_from_unix_time_round_trip_milliseconds() {
        ...
        let timestamp = to_unix_time(2024, 6, 15, 14, 30, 45, true);
    ...
    fn test_from_unix_time_ffi_epoch() {
        ...
        let result = from_unix_time_ffi(0, false, &mut year, &mut month, &mut day, &mut hour, &mut minute, &mut second);
    ...
    fn test_from_unix_time_ffi_year_2000() {
        ...
        let result = from_unix_time_ffi(946684800, false, &mut year, &mut month, &mut day, &mut hour, &mut minute, &mut second);
    ...
    fn test_from_unix_time_ffi_null_year() {
        ...
        let result = from_unix_time_ffi(0, false, std::ptr::null_mut(), &mut month, &mut day, &mut hour, &mut minute, &mut second);
    ...
    fn test_from_unix_time_ffi_null_month() {
        ...
        let result = from_unix_time_ffi(0, false, &mut year, std::ptr::null_mut(), &mut day, &mut hour, &mut minute, &mut second);
    ...
    fn test_from_unix_time_ffi_milliseconds() {
        ...
        let result = from_unix_time_ffi(946684800000, true, &mut year, &mut month, &mut day, &mut hour, &mut minute, &mut second);
